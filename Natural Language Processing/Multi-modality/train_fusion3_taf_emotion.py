...
OUT_DIR = "/mnt/optimusmesh/checkingfiles/fusion3_taf_outputs_emotion"
...
def save_metrics_json(train_loss, train_acc, dev_loss, dev_acc, test_loss, test_acc):
    out_path = f"{RESULTS_DIR}/fusion3_taf_emotion_metrics.json"
    metrics = {
        "task": "fusion3_taf_emotion",
...
def run():
    ...
    best_dev_acc = 0.0
    best_path = f"{OUT_DIR}/best_fusion3_taf_emotion.pt"
    ...
    print("\n========== FINAL RESULTS: FUSION3 TAF EMOTION ==========\n")
